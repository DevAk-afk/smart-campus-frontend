      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "28px", flexWrap: "wrap", gap: "16px" }}>
          <div>
            ...
            <p style={{ fontSize: "13px", color: "#64748b", margin: 0 }}>
              Welcome back, <span style={{ color: "#94a3b8", fontWeight: "500" }}>{user?.name}</span> 👋
            </p>
          </div>
        ...
        {complaints.some(c => c.status === "Resolved" || c.status === "Rejected") && (
          <div style={{
            ...
            {counts.Resolved > 0 && <span style={{ fontSize: "13px", color: "#10b981", fontWeight: "600" }}>✅ {counts.Resolved} Resolved</span>}
            {counts["In Progress"] > 0 && <span style={{ fontSize: "13px", color: "#38bdf8", fontWeight: "600" }}>⚙️ {counts["In Progress"]} In Progress</span>}
            {counts.Rejected > 0 && <span style={{ fontSize: "13px", color: "#ef4444", fontWeight: "600" }}>❌ {counts.Rejected} Rejected</span>}
          </div>
        )}
                ...
                <div style={{ display: "flex", gap: "14px", alignItems: "flex-start" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "8px", marginBottom: "6px" }}>
                      <h3 style={{ margin: 0, fontSize: "14px", fontWeight: "600", color: "#f1f5f9" }}>{c.title}</h3>

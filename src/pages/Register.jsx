                ...
                {["student", "admin"].map((r) => (
                  <button key={r} type="button"
                    ...
                    style={{
                      ...
                      border: form.role === r ? "1px solid rgba(56,189,248,0.4)" : "1px solid rgba(255,255,255,0.08)",
                      background: form.role === r ? "rgba(56,189,248,0.1)" : "transparent",
                      color: form.role === r ? "#38bdf8" : "#64748b",
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "16px" }}>
                <div>
                  ...
                  <input style={inputStyle("roll")} placeholder="e.g. CS21B001"
                    value={form.rollNumber} onFocus={() => setFocused("roll")} onBlur={() => setFocused("")}

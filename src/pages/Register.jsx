    ...
    <div style={{ minHeight: "100vh", background: "#0f172a", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: font, padding: "16px" }}>
      <div style={{ width: "100%", maxWidth: "480px" }}>
        <div style={{ textAlign: "center", marginBottom: "28px" }}>
          <div style={{ width: "52px", height: "52px", margin: "0 auto 14px", background: "linear-gradient(135deg, #3b82f6, #06b6d4)", borderRadius: "14px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "24px", boxShadow: "0 0 24px rgba(59,130,246,0.4)" }}>🎓</div>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "rgba(56,189,248,0.08)", border: "1px solid rgba(56,189,248,0.2)", borderRadius: "20px", padding: "4px 12px", marginBottom: "10px" }}>
            <span style={{ fontSize: "11px", color: "#38bdf8", fontWeight: "600", letterSpacing: "0.8px" }}>STUDENT REGISTRATION</span>
          </div>
          <h1 style={{ fontSize: "20px", fontWeight: "700", color: "#f1f5f9", margin: "0 0 4px", letterSpacing: "-0.5px" }}>Create Student Account</h1>
          <p style={{ fontSize: "13px", color: "#64748b", margin: 0 }}>Register to file and track complaints</p>
        </div>

        <div style={{ background: "#1e293b", borderRadius: "16px", border: "1px solid rgba(56,189,248,0.1)", padding: "24px", boxShadow: "0 20px 40px rgba(0,0,0,0.4)" }}>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: "14px" }}>
              ...
              <input required style={inp("name")} placeholder="John Doe" value={form.name}
            ...
            {/* Roll + Department — stack on mobile */}

    ...
    <div style={{ minHeight: "100vh", background: "#0f172a", fontFamily: font, padding: "40px 20px", color: "#f1f5f9" }}>
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "36px" }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{
              ...
              borderRadius: "20px", padding: "3px 10px", marginBottom: "4px",
            }}>
              <span style={{ fontSize: "10px", color: accent, fontWeight: "600", letterSpacing: "0.5px", textTransform: "uppercase" }}>
                {isAdmin ? "🛡️ Admin Account" : "🎓 Student Account"}
              </span>
            </div>
          ...
          <button
            ...
            style={{
              ...
              color: "#64748b", fontSize: "13px", cursor: "pointer", fontFamily: font,
            }}>
            ← Back
          </button>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: "15px", fontWeight: "600", color: "#94a3b8", margin: "0 0 24px", display: "flex", alignItems: "center", gap: "8px" }}>
            ✏️ Edit Profile Info
          </h2>
          <form onSubmit={handleSaveProfile}>
            ...
            <button type="submit" disabled={saving} style={{
              ...
              boxShadow: saving ? "none" : `0 0 16px ${accentBg}`,
              transition: "all 0.2s", fontFamily: font, marginTop: "8px",
            }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleChangePassword}>
            ...
            <button type="submit" disabled={savingPass} style={{
              width: "100%", padding: "12px",
              background: savingPass ? "#1a2744" : gradient,
              border: "none", borderRadius: "10px", color: "white",
              fontSize: "14px", fontWeight: "600",
              cursor: savingPass ? "not-allowed" : "pointer",
              boxShadow: savingPass ? "none" : `0 0 16px ${accentBg}`,
